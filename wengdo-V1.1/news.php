...
<!-- PHP表单登录验证部分 stop-->
		...
		<!-- ad -->
		<div class="ad">
			<img src="images/ad-list-img.jpg" alt="" width="100%">
		</div>
		...
		<div class="row">
			...
			<!-- 新闻部分 -->
				<div class="contact-content">
					<div class="user-mess-tootip">
						<img src="images/kehu-message.jpg" alt="">
						<div class="user-mess-item">
							“ web最近的消息告诉你。<br>多种多样的消息迅速转达给您。 ”
						</div>
					</div>
					<table class="table table-striped table-hover">
						...
						<tbody>
							<!-- 遍历数组 -->
							<!-- $news_slice取数组的前5段 -->
							<?php foreach( $news_slice as $value) { ?>
							<tr>
								...
								<td><?php echo $value["news_click"] ?></td>
							</tr>
							<?php  } ?>
						</tbody>
					</table>
